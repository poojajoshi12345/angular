		...
		<script type="text/javascript">
			...
			ibx(function()
			{
				$(".font-select").on("ibx_change", function(e)
				{
					...
					if(userValue == "materialicons")
					{
						for(var i = 0; i < materialLigatures.length; ++i)
						{
							var selector = materialLigatures[i];
							var options = 
							{
								textAlign:"center",
								textWrap:true,
								text:selector,
								glyphClasses:fontClasses[userValue],
								glyph:selector,
								iconPosition:"top",
							};
							var tile = $("<div class='font-tile'>").ibxLabel(options).attr("title", selector);
