		...
		<script type="text/javascript">
			...
			{				
				$(".btn-show-text-editor").on("click", function()
				{
					...
					editorDlg.ibxWidget("setEditorPath", "IBFS:/WFC/Repository", "IBFS:/WFC/Repository/HOME-958");	

					editorDlg.ibxWidget("open");
				});
				
			}, ["<%=context%>/ibx/testing/mike_k/ace_editor/resources/ace_editor_bundle.xml"], true);
			//# sourceURL=test.jsp
	...
	<body class="ibx-root">
		<div class="main-box" data-ibx-type="ibxVBox" data-ibxp-justify="center" data-ibxp-align="center">
			...
			<div class="te-blurb">
				...
				The textarea replaced with ACE IDE.
			</div>
		<div>
