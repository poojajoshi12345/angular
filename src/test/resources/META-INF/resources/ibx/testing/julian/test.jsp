...
<html lang="en">
		...
		<script type="text/javascript">
			...
			ibx(function()
			{
				$(".thumb").on("keydown", function(e)
				{
					var slider = $(".thumb");
					var step = 5;
					var val = parseInt(slider.attr("aria-valuenow"), 10);
					if(e.keyCode == $.ui.keyCode.DOWN || e.keyCode == $.ui.keyCode.LEFT)
						val -= step;
					else
					if(e.keyCode == $.ui.keyCode.UP || e.keyCode == $.ui.keyCode.RIGHT)
						val += step;
	...
	<body class="ibx-root">
		<div class="main-box" data-ibx-type="ibxVBox">
			<div id="slider" class="slider" tabIndex="0" data-ibx-type="ibxHBox" data-ibxp-align="stretch">
				<div id="thumb" class="thumb" tabIndex="0" data-ibxp-aria.role="slider" aria-valuemin="100" aria-valuemax="200" aria-valuenow="150" data-ibx-type="ibxWidget"></div>
			</div>
		</div>
